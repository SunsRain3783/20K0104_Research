...
public class ReplyMapLink extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reply_map_link);
        ...
        gestureDetector = new GestureDetector(this, new ReplyMapLink.SwipeGestureDetector());
        initViews();
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        CursorAdapter adapter = new SimpleCursorAdapter(ReplyMapLink.this,
    ...
    private void performSearch(String query) {
        if (!query.trim().isEmpty()) {
            ...
            Intent intent = new Intent(this, ReplyMapLink.class);
            intent.putExtra("inputText", query);
            intent.putExtra("postId", postId);  // postId を追加
            startActivity(intent);
        } else {
            Toast.makeText(getApplicationContext(), "入力が空です", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onClick(View view) {  //ボタンをクリックしたときの挙動
        if (view.getId() == R.id.mapIcon) {  //switch使うとエラー(if elseを使う)
            ...
            Intent intent = new Intent(this, ReplyUpload.class);
